...
export class RecipeController {
  Recipes = async (_: Request, res: Response) => {
  ...
  createRecipe = async (req: MyUserRequest, res: Response) => {
  ...
  deleteRecipe = async (req: MyUserRequest, res: Response) => {
  ...
  updateRecipe = async (req: MyUserRequest, res: Response) => {
    const id: number = +req.params.id;
